export default function ColorDesignTokens() {
	/* 
		🐨 Replace the "placeholder" colors with the new color tokens

		💰 I have placed a 👀 emoji next to the elements that need attention!
		*/
	return (
		// 👀
			...
			<div className="mx-auto max-w-4xl p-6 sm:p-8">
				...
				<div className="rounded border border-black p-6 sm:p-8">
					...
					<div className="flex gap-2">
						{/* 👀 */}
						<button className="mt-6 rounded bg-black px-4 py-2 text-sm font-medium text-white">
							Learn more
						</button>
					</div>
				</div>
