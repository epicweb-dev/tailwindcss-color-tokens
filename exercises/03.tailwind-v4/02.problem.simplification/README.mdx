...
- --color-highlight: hsl(173 100% 50%);
+ --color-highlight: #00ffe1;
```
...
.bg-highlight\/50 {
	background-color: color-mix(
		in srgb,
		var(--background-color-highlight, var(--color-highlight)) 50%,
		transparent
	);
}
```
...
| ------------------- | ------------------- | --------- |
| `--color-highlight` | `hsl(173 100% 50%)` | `#00FFE1` |
| `--color-accent`    | `hsl(263 100% 50%)` | `#6200FF` |
...
| ------------------- | ------------------- | --------- |
| `--color-highlight` | `hsl(173 100% 30%)` | `#009987` |
| `--color-accent`    | `hsl(263 100% 70%)` | `#A166FF` |

| Citrus theme        | HSL color          | HEX color |
| ------------------- | ------------------ | --------- |
| `--color-highlight` | `hsl(60 100% 50%)` | `#FFFF00` |
| `--color-accent`    | `hsl(30 100% 50%)` | `#FF8000` |

| Citrus theme + Dark mode | HSL color          | HEX color |
| ------------------------ | ------------------ | --------- |
| `--color-highlight`      | `hsl(60 100% 30%)` | `#999900` |
| `--color-accent`         | `hsl(30 100% 70%)` | `#FFB366` |
...
### 3. Delete the 12 raw color variables
